...
PanzerServer::PanzerServer() :
	mCatControlType( ESCT_Human ),
	mTimeOfNextShot( 0.f ),
	mTimeBetweenShots( 0.5f )
{}

void PanzerServer::HandleDying()
{
	NetworkManagerServer::sInstance->UnregisterGameObject( this );
}

void PanzerServer::Update()
{
	Panzer::Update();
...
void PanzerServer::HandleShooting()
{
...
void PanzerServer::TakeDamage( int inDamagingPlayerId )
{
	mHealth--;
	if( mHealth <= 0.f )
	{
