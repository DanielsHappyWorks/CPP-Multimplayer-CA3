...
void PanzerClient::Read( InputMemoryBitStream& inInputStream )
{
	bool stateBit;
...
void PanzerClient::DoClientSidePredictionAfterReplicationForLocalCat( uint32_t inReadState )
{
...
void PanzerClient::InterpolateClientSidePrediction( float inOldRotation, const Vector3& inOldLocation, const Vector3& inOldVelocity, bool inIsForRemoteCat )
{
...
void PanzerClient::DoClientSidePredictionAfterReplicationForRemoteCat( uint32_t inReadState )
{
	if( ( inReadState & ECRS_Pose ) != 0 )
	{
